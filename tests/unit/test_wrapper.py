...
class TestWrapper(unittest.TestCase):
    ...
    @staticmethod
    def mock_tankopedia_vehicles():
        responses = {"status": "ok", "meta": {"count": 757, "page_total": 8, "total": 757, "limit": 100, "page": None},
                     "data": {"1": {"is_wheeled": False, "radios": [1287, 775], "is_premium": False, "tag": "R04_T-34",
                                    "images": {
                                    ...
                                    "tank_id": 1, "suspensions": [258, 2],
                                    "provisions": [112123, 103419, 92667, 103675, 47099, 2381307, 109051, 104187, 97787,
                                                   104443, 112379, 104699, 104955, 105211, 96251, 14843, 109307, 105467,
                                                   105723, 112635, 105979, 11771, 47611, 106235, 106491, 50939, 109563,
                                                   106747, 107003, 112891, 107259, 107515, 107771, 15355, 109819,
                                                   108283, 26619, 92411, 27131, 92923, 93179, 93435, 58107, 28155,
                                                   110331, 12283, 28923, 98043, 110843, 103163, 12795, 111355, 29691,
                                                   29947, 29179, 28411, 30203, 95995, 14331, 48891, 26107, 3323, 52219,
                                                   113147, 29435, 113403, 113659, 110587, 113915, 26363, 114171, 97531,
                                                   52475, 111099, 114683, 114427, 251, 46075, 507, 59131, 98811, 94971,
                                                   763, 98299, 27899, 1019, 93691, 1275, 1531, 1787, 95227, 26875,
                                                   51195, 98555, 51451, 111611, 51707, 51963, 3067, 95483, 27387,
                                                   108539, 2330107, 95739, 111867, 108027, 28667, 110075, 102651,
                                                   2355707, 103931, 50171, 108795, 102907, 13049, 23545, 13305, 24569,
                                                   25337, 29945, 13817, 27129, 12537, 27385, 11257, 27897, 11769, 28409,
                                                   28665, 28921, 29177, 29433, 29689, 13561, 30201, 14073, 14329, 19193,
                                                   27641, 15097, 15353, 15865, 16633, 28153, 18425, 17657, 11513, 12025,
                                                   19705, 20473, 20985, 26105, 21753, 23033], "engines": [261, 5],
                                    "crew": [{"roles": {"commander": "Commander", "gunner": "Gunner"},
                                              "member_id": "commander"},
                                             {"roles": {"radioman": "Radio Operator"}, "member_id": "radioman"},
                                             {"roles": {"driver": "Driver"}, "member_id": "driver"},
                                             {"roles": {"loader": "Loader"}, "member_id": "loader"}],
                                    "type": "mediumTank", "guns": [4, 1284, 1540, 516], "multination": None,
                                    ...
                                    "short_name": "T-34", "is_premium_igr": False,
                                    "next_tanks": {"2561": 27825, "12289": 29660}, "modules_tree": {
                             "258": {"name": "T-34 mod. 1943", "next_modules": None, "next_tanks": None,
                                     "is_default": False, "price_xp": 1940, "price_credit": 7960, "module_id": 258,
                                     "type": "vehicleChassis"},
                             "259": {"name": "T-34 mod. 1942", "next_modules": [1540], "next_tanks": None,
                                     "is_default": False, "price_xp": 1735, "price_credit": 10000, "module_id": 259,
                                     "type": "vehicleTurret"},
                             "516": {"name": "76 mm F-34", "next_modules": [1284], "next_tanks": [12289],
                                     "is_default": False, "price_xp": 1650, "price_credit": 30550, "module_id": 516,
                                     "type": "vehicleGun"},
                             "261": {"name": "V-2-34", "next_modules": None, "next_tanks": None, "is_default": False,
                                     "price_xp": 5000, "price_credit": 27860, "module_id": 261,
                                     "type": "vehicleEngine"},
                             "1287": {"name": "9RM", "next_modules": None, "next_tanks": None, "is_default": False,
                                      "price_xp": 4040, "price_credit": 24240, "module_id": 1287,
                                      "type": "vehicleRadio"},
                             "775": {"name": "9R", "next_modules": [1287], "next_tanks": None, "is_default": True,
                                     "price_xp": 0, "price_credit": 1980, "module_id": 775, "type": "vehicleRadio"},
                             "2": {"name": "T-34 mod. 1941", "next_modules": [258], "next_tanks": None,
                                   "is_default": True, "price_xp": 0, "price_credit": 2680, "module_id": 2,
                                   "type": "vehicleChassis"},
                             "1540": {"name": "76 mm S-54", "next_modules": None, "next_tanks": [2561],
                                      "is_default": False, "price_xp": 4300, "price_credit": 40130, "module_id": 1540,
                                      "type": "vehicleGun"},
                             "3": {"name": "T-34 mod. 1940", "next_modules": [259], "next_tanks": None,
                                   "is_default": True, "price_xp": 0, "price_credit": 3980, "module_id": 3,
                                   "type": "vehicleTurret"},
                             "1284": {"name": "57 mm ZiS-4", "next_modules": None, "next_tanks": None,
                                      "is_default": False, "price_xp": 2200, "price_credit": 41480, "module_id": 1284,
                                      "type": "vehicleGun"},
                             "4": {"name": "76 mm L-11", "next_modules": [516], "next_tanks": None, "is_default": True,
                                   "price_xp": 0, "price_credit": 25990, "module_id": 4, "type": "vehicleGun"},
                             "5": {"name": "V-2", "next_modules": [261], "next_tanks": None, "is_default": True,
                                   "price_xp": 0, "price_credit": 18750, "module_id": 5, "type": "vehicleEngine"}},
                                    "nation": "ussr", "tier": 5, "prices_xp": {"769": 11500}, "is_gift": False,
                                    "name": "T-34", "price_gold": 0, "price_credit": 356700, "default_profile": {
                             "engine": {"name": "V-2", "power": 480, "weight": 750, "tag": "V-2", "fire_chance": 0.15,
                                        "tier": 5}, "siege": None, "max_ammo": 90,
                             "suspension": {"name": "T-34 mod. 1941", "weight": 8000, "load_limit": 30000,
                                            "tag": "T-34_mod_1941", "traverse_speed": 37, "tier": 4,
                                            "steering_lock_angle": 0}, "weight": 27940,
                             "armor": {"turret": {"front": 45, "sides": 45, "rear": 45},
                                       "hull": {"front": 45, "sides": 45, "rear": 40}}, "hp": 560,
                             "modules": {"gun_id": 4, "suspension_id": 2, "turret_id": 3, "radio_id": 775,
                                         "engine_id": 5},
                             "gun": {"move_down_arc": 6, "caliber": 76, "name": "76 mm L-11", "weight": 660,
                                     "move_up_arc": 17, "fire_rate": 10.0, "dispersion": 0.51, "tag": "_76mm_L-11",
                                     "traverse_speed": 39, "reload_time": 6.0, "tier": 4, "aim_time": 2.9},
                             "turret": {"name": "T-34 mod. 1940", "weight": 3200, "view_range": 320, "hp": 88,
                                        "tag": "T-34_mod_1940", "traverse_speed": 40, "traverse_right_arc": 180,
                                        "tier": 4, "traverse_left_arc": 180}, "hull_weight": 15000,
                             "radio": {"tier": 4, "signal_range": 325, "tag": "_9R", "name": "9R", "weight": 80},
                             "rapid": None, "speed_forward": 56, "hull_hp": 472, "speed_backward": 20, "ammo": [
                                 {"penetration": [51, 68, 85], "stun": None, "type": "ARMOR_PIERCING",
                                  "damage": [83, 110, 138]},
                                 {"penetration": [56, 75, 94], "stun": None, "type": "HOLLOW_CHARGE",
                                  "damage": [83, 110, 138]},
                                 {"penetration": [29, 38, 48], "stun": None, "type": "HIGH_EXPLOSIVE",
                                  "damage": [117, 156, 195]}], "max_weight": 30000}, "turrets": [259, 3]}
                              }
                     }
